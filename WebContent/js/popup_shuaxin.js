...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="close" src=/hotel/img/dialogclose.gif  />';
   ...
   if(!this.config.isBackgroundCanClick)G('dialogBoxBG').style.display='none';window.location.reload();
